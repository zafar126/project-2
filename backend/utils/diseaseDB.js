export const DISEASES = {
  "diabetes": {
    ...
    diet: { eat: ["Oats","Bitter gourd","Spinach","Apple","Lentils","Nuts"], avoid: ["Sugar","White bread","Cola","Sweets"] },
    sleep: "7–8 hours",
  ...
  "hypertension": {
    ...
    diet: { eat: ["Banana","Garlic","Avocado","Leafy greens","Oats"], avoid: ["Salt","Fried foods","Excess caffeine"] },
    sleep: "7–8 hours",
